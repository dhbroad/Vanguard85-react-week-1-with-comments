...
const Contact = () => {
    ...
    const [name, setName] = useState('shoha') //The initial state can also be a function: useState(() => {bodyOfFunctionGoesInHere}) which is helpful if the thing you are returning takes a minute to compute, so it doesn't have to compute it every time it re-renders
